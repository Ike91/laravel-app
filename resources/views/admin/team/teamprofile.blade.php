                    ...
                    <div class="tab-content" id="faq-tab-content">
                        <div class="tab-pane show active" id="tab1" role="tabpanel" aria-labelledby="tab1">
                            <div class="accordion" id="accordion-tab-1">
                                <div class="card" style="border-radius: 10px; border: 1px solid white !important;">
                                            ...
                                            <div class="container-fluid">
                                              <div class="row">
                                                <div class="col-md-3">
                                                  ...
                                                  @foreach ($team as $item)
                                                  <!-- About Me Box -->
                                                  <div class="card card-primary crd">
                                                    ...
                                                    <div class="card-body">
                                                      ...
                                                      <hr>
                                                       <strong><i class="far fa-file-alt mr-1"></i>Recent Academic record</strong>
                                                         <p class="text-muted" style="margin-top: 5px;">
                                                            Academic record <i class="fa fa-file-pdf-o" style="font-size:10px;color:green"></i>                                                           
                                                         </p>
                                                    </div>
                                                    <!-- /.card-body -->
                                                  </div>
                                                ...
                                                <div class="col-md-9">
                                                  <div class="card">
                                                    ...
                                                    <div class="card-body" style="background: grey; border-bottom-left-radius: 10px; border-bottom-right-radius:10px; border: 1px solid white !important;">
                                                      <div class="tab-content">
                                                        ...
                                                        <div class="tab-pane" id="settings">
                                                          ...
                                                          <form class="form-horizontal" action="{{route('updateteamprofile')}}" role="form" method="POST" enctype="multipart/form-data">
                                                            @csrf
                                                            <div class="form-group row">
                                                              <label for="inputName" class="col-sm-2 col-form-label">Name and Surname</label>
                                                              <div class="col-sm-10">
                                                                <input type="text" class="form-control" id="inputName" value="{{Auth::user()->name}}" name="name" placeholder="Name and Surname">
                                                              </div>
                                                            </div>
                                                            <div class="form-group row">
                                                            ...
                                                            <div class="form-group row">
                                                              <label for="inputprofile" class="col-sm-2 col-form-label">Profile photo</label>
                                                              <div class="col-sm-10">
