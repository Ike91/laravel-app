          ...
          <div class="row">
              <div class="col">
               ...
               <tr>
                ...
                <tr>
                  <td>1 </td>
                  <td>Constructing Geometric Figures</td>
                  <td></td>
              </tr>
              <tr>
                  <td>2</td>
              ...
              <tr>
                <td>4</td>
                <td>Theorem of pythagoras</td>
                <td></td>
              </tr>
              <tr>
                <tr>
                  <td>5</td>
                  <td>Area and Perimeter of 2-D shapes</td>
                  <td></td>
              </tr>
                  ...
                  <div class="form-row schedule-form">
                    <div class="col-md-6">	          	
                       ...
                       <select id="yOrg" name="grade" class="form-control">
                        <option selected>--Select--</option>
                        <option value="grade 11">Grade 10</option>
                     </select>	
                    </div> 
                    <div class="col-md-6">	       	
