          ...
          <div class="row">
            <div class="col">
             <div class="grade">
              ...
              <hr style="margin-right: 14px; margin-left: 15px;">
              <table class="table1">
                <tr id="header-2">
                    <th>#</th>
                    <th>Description</th>
                ...
                <tr>
                    <td>2</td>
                    <td>Patterns, Sequences and Series</td>
                    <td>25 ± 3</td>
                    <td>25 ± 3</td>
                </tr>
                <tr>
                  <td>3 </td>
                  <td>Finance, growth and decay</td>
                  <td>15 ± 3</td>
                  <td>15 ± 3</td>
              </tr>
              <tr>
            ...
            <tr>
              <td>6</td>
              <td>Probability and Counting Principles</td>
              <td>20 ± 3</td>
              <td>15 ± 3</td>
          </tr>
          <tr>
          ...
          alongside and we will do the rest 
            ...
            <hr style="margin-right: 15px;">
              <div class="forwmwraper">
                  <form class="form-horizontal templatemo-login-form-2 " role="form" action="{{'studentstore'}}" method="POST">
                    @csrf
                    ...
                    <div class="form-row schedule-form">
                      ...
                      <div class="col-md-6">	       	
                        ...
                        <select id="selectCourse." name="subject" class="form-control selected">
                          ...
                          <option  value="Mathematics_lit">&nbsp;&nbsp;&nbsp;Mathematics literacy</option>
